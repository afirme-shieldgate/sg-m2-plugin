...
Install a specific version.  `composer require shieldgate/payment-gateway:2.3.0`
...
## Maintenance
If you need update the plugin to latest version execute: `composer update shieldgate/payment-gateway` or `composer require shieldgate/payment-gateway:2.3.0` for specific version.
