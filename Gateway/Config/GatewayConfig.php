...
namespace Shieldgate\PaymentGateway\Gateway\Config;

use Magento\Framework\App\Config\ScopeConfigInterface;
use Magento\Payment\Gateway\Config\Config;
use Shieldgate\PaymentGateway\Helper\FooLogger;
use Shieldgate\PaymentGateway\Helper\Logger;
use Shieldgate\PaymentGateway\Model\Adminhtml\Source\Env;

class GatewayConfig extends Config
{
    // === CONSTANTS === //
    const GATEWAY_CODE = 'shieldgate_gateway';
    const CODE = 'shieldgate_gateway';
    const ACTIVE = 'active';
    const TITLE = 'title';
